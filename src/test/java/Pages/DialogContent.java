...
public class DialogContent extends Parent{
    ...
    public  void findAndClick(WebElement element){ // bütün butonlar için oluşturduğum fonksiyonum

        clickFunction(element);
    }

    public void findAndSend(WebElement element,String yazi){ // YAZI GÖNDERME İÇİN FONKSİYONUM
